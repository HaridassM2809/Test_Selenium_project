...
public class Ex_array {
	...
	public void arrayMethod1() {
		...
		for(int i=0;i<arr1.length;i++) {
			System.out.println("Show arr ["+i+"] index value of: "+arr1[i]); // this loop will show the array index values
		}
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
//		Array cloned
		...
		for(int i=0;i<arr2.length;i++) {
			System.out.println("Show arr2 ["+i+"] index value of: "+arr2[i]); // this loop will show the array index values
		}
